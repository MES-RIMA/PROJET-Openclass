...
import com.openclassrooms.realestatemanager.utils.EstateContentProvider;
...
public class ContentProviderTest {
    ...
    public void getItemsWhenNoItemInserted() {
        final Cursor cursor = contentResolver.query(ContentUris.withAppendedId(EstateContentProvider.URI_PROPERTY, 1),
                null, null, null, null);
    ...
    public void insertAndGetProperty() {
        // Add a property
        final Uri houseUri = contentResolver.insert(EstateContentProvider.URI_PROPERTY, generateDummyProperty());
        final Cursor cursor =
                contentResolver.query(ContentUris.withAppendedId(EstateContentProvider.URI_PROPERTY, 1),
                        null, null, null, null);
