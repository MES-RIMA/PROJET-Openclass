...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void configureMapObjects() {
        mMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(requireContext(), R.raw.google_map));
    ...
    private void initObservers() {
        mPropertyListViewModel.getCurrentPropertiesList().observe(getViewLifecycleOwner(),
                this::updateEveryProperties);
